...
1. **Prometheus scrape config location**
   ...
   - **Status:** Deferred to Phase 2 per CONTEXT.md
...
2. **RabbitMQ prometheus plugin enablement mechanism**
   ...
   - **Recommendation:** Phase 1 template should include a comment explaining the plugin activation. Phase 2 skill can mount the enabled_plugins file.
...
3. **Root compose.yml template**
   ...
   - **Status:** Deferred to Phase 2 per CONTEXT.md; Phase 1 only authors per-service templates
